# -*- coding: utf-8 -*-
# Generated by Django 1.11 on 2018-07-04 02:16
    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('status', models.CharField(choices=[('pending', 'Pending'), ('accept', 'Accept'), ('delivered', 'Delivered'), ('reject', 'Reject'), ('cancel', 'Cancel')], default='pending', max_length=50, verbose_name='Status')),
